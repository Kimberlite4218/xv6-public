...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 f1 77 10 80 	movl   $0x801077f1,(%esp)
...
80100af6:	e8 c5 60 00 00       	call   80106bc0 <allocuvm>
...
80100b28:	e8 d3 5f 00 00       	call   80106b00 <loaduvm>
...
80100baa:	e8 11 60 00 00       	call   80106bc0 <allocuvm>
...
80100d34:	e8 37 5c 00 00       	call   80106970 <switchuvm>
  freevm(oldpgdir);
...
80101bae:	e8 dd 29 00 00       	call   80104590 <strncmp>
}
80101bb3:	c9                   	leave  
80101bb4:	c3                   	ret    
...
80101c0d:	e8 7e 29 00 00       	call   80104590 <strncmp>
      continue;
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 b5 3a 00 00       	call   80106950 <switchkvm>
  seginit();
...
80102ef4:	e8 97 2c 00 00       	call   80105b90 <uartinit>
  pinit();         // process table
...
80103654:	89 43 14             	mov    %eax,0x14(%ebx)
  release(&ptable.lock);
...
80103671:	89 43 0c             	mov    %eax,0xc(%ebx)
...
8010367f:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103684:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103687:	c7 40 14 12 57 10 80 	movl   $0x80105712,0x14(%eax)
  p->context = (struct context*)sp;
8010368e:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
...
8010369b:	8b 43 20             	mov    0x20(%ebx),%eax
...
801036c8:	c3                   	ret    
    p->state = UNUSED;
801036c9:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return 0;
...
801037bd:	68 78 76 10 80       	push   $0x80107678
...
80103833:	e8 58 35 00 00       	call   80106d90 <setupkvm>
80103838:	85 c0                	test   %eax,%eax
8010383a:	89 43 08             	mov    %eax,0x8(%ebx)
...
80103851:	e8 2a 32 00 00       	call   80106a80 <inituvm>
...
80103863:	ff 73 1c             	pushl  0x1c(%ebx)
...
801038e0:	e8 6b 0a 00 00       	call   80104350 <acquire>
  p->state = RUNNABLE;
801038e5:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  release(&ptable.lock);
...
80103903:	68 ac 75 10 80       	push   $0x801075ac
...
8010393c:	e8 2f 30 00 00       	call   80106970 <switchuvm>
  return 0;
...
80103957:	ff 73 08             	pushl  0x8(%ebx)
8010395a:	e8 61 32 00 00       	call   80106bc0 <allocuvm>
...
80103977:	ff 73 08             	pushl  0x8(%ebx)
8010397a:	e8 61 33 00 00       	call   80106ce0 <deallocuvm>
...
801039c3:	ff 73 08             	pushl  0x8(%ebx)
801039c6:	89 c7                	mov    %eax,%edi
801039c8:	e8 93 34 00 00       	call   80106e60 <copyuvm>
801039cd:	83 c4 10             	add    $0x10,%esp
801039d0:	85 c0                	test   %eax,%eax
801039d2:	89 47 08             	mov    %eax,0x8(%edi)
...
801039e0:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
801039e2:	89 59 18             	mov    %ebx,0x18(%ecx)
801039e5:	89 c8                	mov    %ecx,%eax
  *np->tf = *curproc->tf;
801039e7:	8b 79 1c             	mov    0x1c(%ecx),%edi
801039ea:	8b 73 1c             	mov    0x1c(%ebx),%esi
801039ed:	b9 13 00 00 00       	mov    $0x13,%ecx
801039f2:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
801039f4:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
801039f6:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80103a82:	ff 73 0c             	pushl  0xc(%ebx)
80103a85:	e8 96 e8 ff ff       	call   80102320 <kfree>
    np->kstack = 0;
80103a8a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    np->state = UNUSED;
80103a91:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
...
80103ae9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      if(p->state != RUNNABLE)
80103af0:	83 7b 10 03          	cmpl   $0x3,0x10(%ebx)
...
80103b00:	e8 6b 2e 00 00       	call   80106970 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103b05:	58                   	pop    %eax
80103b06:	5a                   	pop    %edx
80103b07:	ff 73 20             	pushl  0x20(%ebx)
80103b0a:	57                   	push   %edi
      p->state = RUNNING;
80103b0b:	c7 43 10 04 00 00 00 	movl   $0x4,0x10(%ebx)
      swtch(&(c->scheduler), p->context);
80103b12:	e8 a4 0b 00 00       	call   801046bb <swtch>
      switchkvm();
80103b17:	e8 34 2e 00 00       	call   80106950 <switchkvm>
      c->proc = 0;
...
80103b8a:	75 68                	jne    80103bf4 <sched+0xa4>
  if(p->state == RUNNING)
80103b8c:	83 7b 10 04          	cmpl   $0x4,0x10(%ebx)
...
80103b9e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
...
80103c87:	8b 56 18             	mov    0x18(%esi),%edx
...
80103cd9:	73 33                	jae    80103d0e <exit+0xfe>
    if(p->parent == curproc){
80103cdb:	39 72 18             	cmp    %esi,0x18(%edx)
80103cde:	75 f0                	jne    80103cd0 <exit+0xc0>
      if(p->state == ZOMBIE)
80103ce0:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
      p->parent = initproc;
80103ce4:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
...
80103d66:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
...
80103ddd:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103de0:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
...
80103e18:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103e1b:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
...
80103e39:	68 2f 76 10 80       	push   $0x8010762f
80103e3e:	e8 4d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e43:	83 ec 0c             	sub    $0xc,%esp
80103e46:	68 29 76 10 80       	push   $0x80107629
...
80103e91:	73 1b                	jae    80103eae <wait+0x5e>
      if(p->parent != curproc)
80103e93:	39 73 18             	cmp    %esi,0x18(%ebx)
80103e96:	75 f0                	jne    80103e88 <wait+0x38>
      if(p->state == ZOMBIE){
80103e98:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
...
80103ed3:	ff 73 0c             	pushl  0xc(%ebx)
        pid = p->pid;
80103ed6:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
...
80103edf:	ff 73 08             	pushl  0x8(%ebx)
        p->kstack = 0;
80103ee2:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
80103ee9:	e8 22 2e 00 00       	call   80106d10 <freevm>
        release(&ptable.lock);
80103eee:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103ef5:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80103efc:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
...
8010403b:	68 f1 77 10 80       	push   $0x801077f1
...
80104051:	0f 83 81 00 00 00    	jae    801040d8 <procdump+0xb8>
    if(p->state == UNUSED)
80104057:	8b 43 10             	mov    0x10(%ebx),%eax
8010405a:	85 c0                	test   %eax,%eax
8010405c:	74 ea                	je     80104048 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010405e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104061:	ba 40 76 10 80       	mov    $0x80107640,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104066:	77 11                	ja     80104079 <procdump+0x59>
80104068:	8b 14 85 a0 76 10 80 	mov    -0x7fef8960(,%eax,4),%edx
      state = "???";
8010406f:	b8 40 76 10 80       	mov    $0x80107640,%eax
...
8010407e:	ff 73 14             	pushl  0x14(%ebx)
80104081:	68 44 76 10 80       	push   $0x80107644
80104086:	e8 d5 c5 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010408b:	83 c4 10             	add    $0x10,%esp
8010408e:	83 7b 10 02          	cmpl   $0x2,0x10(%ebx)
...
8010409e:	8b 43 20             	mov    0x20(%ebx),%eax
...
801040bd:	68 81 70 10 80       	push   $0x80107081
...
801040ea:	68 b8 76 10 80       	push   $0x801076b8
...
8010415e:	8b 40 14             	mov    0x14(%eax),%eax
...
801041e8:	39 58 14             	cmp    %ebx,0x14(%eax)
...
80104305:	68 c3 76 10 80       	push   $0x801076c3
8010430a:	e8 81 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010430f:	83 ec 0c             	sub    $0xc,%esp
80104312:	68 da 76 10 80       	push   $0x801076da
...
801043f7:	68 e1 76 10 80       	push   $0x801076e1
...
8010444c:	68 e9 76 10 80       	push   $0x801076e9
...
801048a8:	50                   	push   %eax
            curproc->pid, curproc->name, num);
801048a9:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
801048ac:	50                   	push   %eax
801048ad:	ff 73 14             	pushl  0x14(%ebx)
801048b0:	68 f1 76 10 80       	push   $0x801076f1
801048b5:	e8 a6 bd ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
801048ba:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
801048e7:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801048ea:	e8 21 d6 ff ff       	call   80101f10 <nameiparent>
...
8010490e:	e8 ad d2 ff ff       	call   80101bc0 <dirlookup>
80104913:	83 c4 10             	add    $0x10,%esp
80104916:	85 c0                	test   %eax,%eax
80104918:	89 c7                	mov    %eax,%edi
8010491a:	74 34                	je     80104950 <create+0x80>
    iunlockput(dp);
8010491c:	83 ec 0c             	sub    $0xc,%esp
8010491f:	53                   	push   %ebx
80104920:	e8 fb cf ff ff       	call   80101920 <iunlockput>
    ilock(ip);
80104925:	89 3c 24             	mov    %edi,(%esp)
80104928:	e8 63 cd ff ff       	call   80101690 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010492d:	83 c4 10             	add    $0x10,%esp
80104930:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104935:	0f 85 95 00 00 00    	jne    801049d0 <create+0x100>
8010493b:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104940:	0f 85 8a 00 00 00    	jne    801049d0 <create+0x100>
...
8010495a:	e8 c1 cb ff ff       	call   80101520 <ialloc>
...
80104991:	e8 4a cc ff ff       	call   801015e0 <iupdate>
...
801049a8:	e8 83 d4 ff ff       	call   80101e30 <dirlink>
...
801049bc:	e8 5f cf ff ff       	call   80101920 <iunlockput>
  return ip;
...
801049d4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
801049d6:	e8 45 cf ff ff       	call   80101920 <iunlockput>
    return 0;
...
801049f9:	e8 e2 cb ff ff       	call   801015e0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801049fe:	83 c4 0c             	add    $0xc,%esp
80104a01:	ff 77 04             	pushl  0x4(%edi)
80104a04:	68 94 77 10 80       	push   $0x80107794
80104a09:	57                   	push   %edi
80104a0a:	e8 21 d4 ff ff       	call   80101e30 <dirlink>
...
80104a1c:	68 93 77 10 80       	push   $0x80107793
80104a21:	57                   	push   %edi
80104a22:	e8 09 d4 ff ff       	call   80101e30 <dirlink>
...
80104a94:	e8 57 ed ff ff       	call   801037f0 <myproc>
80104a99:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104a9c:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104ad9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104adb:	e8 10 ed ff ff       	call   801037f0 <myproc>
...
80104af0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80104af4:	85 d2                	test   %edx,%edx
80104af6:	75 f0                	jne    80104ae8 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80104af8:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104b4d:	e8 2e fc ff ff       	call   80104780 <argint>
...
80104b65:	e8 66 fc ff ff       	call   801047d0 <argptr>
...
80104c23:	78 2b                	js     80104c50 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104c25:	e8 c6 eb ff ff       	call   801037f0 <myproc>
80104c2a:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104c2d:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104c30:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104c37:	00 
  fileclose(f);
...
80104cf3:	e8 f8 d1 ff ff       	call   80101ef0 <namei>
...
80104d09:	e8 82 c9 ff ff       	call   80101690 <ilock>
  if(ip->type == T_DIR){
...
80104d28:	e8 b3 c8 ff ff       	call   801015e0 <iupdate>
  iunlock(ip);
80104d2d:	89 1c 24             	mov    %ebx,(%esp)
80104d30:	e8 3b ca ff ff       	call   80101770 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104d35:	58                   	pop    %eax
80104d36:	5a                   	pop    %edx
80104d37:	57                   	push   %edi
80104d38:	ff 75 d0             	pushl  -0x30(%ebp)
80104d3b:	e8 d0 d1 ff ff       	call   80101f10 <nameiparent>
...
80104d4d:	e8 3e c9 ff ff       	call   80101690 <ilock>
...
80104d63:	e8 c8 d0 ff ff       	call   80101e30 <dirlink>
...
80104d7b:	e8 40 ca ff ff       	call   801017c0 <iput>
  end_op();
...
80104d9c:	e8 7f cb ff ff       	call   80101920 <iunlockput>
    goto bad;
80104da1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104da4:	83 ec 0c             	sub    $0xc,%esp
80104da7:	53                   	push   %ebx
80104da8:	e8 e3 c8 ff ff       	call   80101690 <ilock>
  ip->nlink--;
80104dad:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104db2:	89 1c 24             	mov    %ebx,(%esp)
80104db5:	e8 26 c8 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
80104dba:	89 1c 24             	mov    %ebx,(%esp)
80104dbd:	e8 5e cb ff ff       	call   80101920 <iunlockput>
  end_op();
...
80104ded:	eb 9b                	jmp    80104d8a <sys_link+0xda>
    end_op();
80104def:	e8 2c de ff ff       	call   80102c20 <end_op>
    return -1;
...
80104e1f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104e22:	e8 89 dd ff ff       	call   80102bb0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104e27:	83 ec 08             	sub    $0x8,%esp
80104e2a:	53                   	push   %ebx
80104e2b:	ff 75 c0             	pushl  -0x40(%ebp)
80104e2e:	e8 dd d0 ff ff       	call   80101f10 <nameiparent>
...
80104e44:	e8 47 c8 ff ff       	call   80101690 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104e49:	58                   	pop    %eax
80104e4a:	5a                   	pop    %edx
80104e4b:	68 94 77 10 80       	push   $0x80107794
80104e50:	53                   	push   %ebx
80104e51:	e8 4a cd ff ff       	call   80101ba0 <namecmp>
...
80104e64:	68 93 77 10 80       	push   $0x80107793
80104e69:	53                   	push   %ebx
80104e6a:	e8 31 cd ff ff       	call   80101ba0 <namecmp>
...
80104e83:	e8 38 cd ff ff       	call   80101bc0 <dirlookup>
...
80104e99:	e8 f2 c7 ff ff       	call   80101690 <ilock>
  if(ip->nlink < 1)
...
80104ecd:	e8 9e cb ff ff       	call   80101a70 <writei>
...
80104efa:	e8 e1 c6 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
80104eff:	89 1c 24             	mov    %ebx,(%esp)
80104f02:	e8 19 ca ff ff       	call   80101920 <iunlockput>
  end_op();
80104f07:	e8 14 dd ff ff       	call   80102c20 <end_op>
  return 0;
...
80104f44:	e8 27 ca ff ff       	call   80101970 <readi>
...
80104f68:	e8 b3 c9 ff ff       	call   80101920 <iunlockput>
  end_op();
80104f6d:	e8 ae dc ff ff       	call   80102c20 <end_op>
  return -1;
...
80104f89:	e8 52 c6 ff ff       	call   801015e0 <iupdate>
...
8010502d:	e8 be ce ff ff       	call   80101ef0 <namei>
...
80105043:	e8 48 c6 ff ff       	call   80101690 <ilock>
...
8010505f:	0f 84 a6 00 00 00    	je     8010510b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105065:	e8 86 e7 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105076:	0f 84 ac 00 00 00    	je     80105128 <sys_open+0x148>
    if(curproc->ofile[fd] == 0){
8010507c:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80105084:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105087:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
8010508b:	56                   	push   %esi
8010508c:	e8 df c6 ff ff       	call   80101770 <iunlock>
  end_op();
80105091:	e8 8a db ff ff       	call   80102c20 <end_op>
...
8010510f:	e8 0c c8 ff ff       	call   80101920 <iunlockput>
    end_op();
80105114:	e8 07 db ff ff       	call   80102c20 <end_op>
    return -1;
...
80105143:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105146:	e8 65 da ff ff       	call   80102bb0 <begin_op>
...
8010518f:	c3                   	ret    
    end_op();
80105190:	e8 8b da ff ff       	call   80102c20 <end_op>
    return -1;
...
8010520e:	e8 0d c7 ff ff       	call   80101920 <iunlockput>
  end_op();
80105213:	e8 08 da ff ff       	call   80102c20 <end_op>
  return 0;
...
8010523d:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
8010523f:	e8 6c d9 ff ff       	call   80102bb0 <begin_op>
...
8010525f:	e8 8c cc ff ff       	call   80101ef0 <namei>
...
80105271:	e8 1a c4 ff ff       	call   80101690 <ilock>
  if(ip->type != T_DIR){
...
80105284:	e8 e7 c4 ff ff       	call   80101770 <iunlock>
  iput(curproc->cwd);
80105289:	58                   	pop    %eax
8010528a:	ff 76 6c             	pushl  0x6c(%esi)
8010528d:	e8 2e c5 ff ff       	call   801017c0 <iput>
  end_op();
80105292:	e8 89 d9 ff ff       	call   80102c20 <end_op>
  curproc->cwd = ip;
80105297:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
...
801052b4:	e8 67 c6 ff ff       	call   80101920 <iunlockput>
    end_op();
801052b9:	e8 62 d9 ff ff       	call   80102c20 <end_op>
    return -1;
...
801053fc:	e8 4f de ff ff       	call   80103250 <pipealloc>
...
8010540f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105411:	e8 da e3 ff ff       	call   801037f0 <myproc>
...
8010544e:	74 28                	je     80105478 <sys_pipe+0xa8>
    if(curproc->ofile[fd] == 0){
80105450:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
80105454:	85 c9                	test   %ecx,%ecx
80105456:	75 f0                	jne    80105448 <sys_pipe+0x78>
      curproc->ofile[fd] = f;
80105458:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80105471:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105478:	e8 73 e3 ff ff       	call   801037f0 <myproc>
8010547d:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
80105484:	00 
...
801054b3:	5d                   	pop    %ebp
  return fork();
801054b4:	e9 d7 e4 ff ff       	jmp    80103990 <fork>
...
801054c3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054c6:	e8 45 e7 ff ff       	call   80103c10 <exit>
...
801054d3:	5d                   	pop    %ebp
  return wait();
801054d4:	e9 77 e9 ff ff       	jmp    80103e50 <wait>
...
8010552b:	8b 40 14             	mov    0x14(%eax),%eax
}
8010552e:	c9                   	leave  
8010552f:	c3                   	ret    
...
8010553f:	e8 3c f2 ff ff       	call   80104780 <argint>
80105544:	83 c4 10             	add    $0x10,%esp
80105547:	85 c0                	test   %eax,%eax
80105549:	0f 88 a1 00 00 00    	js     801055f0 <sys_sbrk+0xc0>
    return -1;
  addr = myproc()->sz;
8010554f:	e8 9c e2 ff ff       	call   801037f0 <myproc>
80105554:	8b 18                	mov    (%eax),%ebx
  myproc()->sz += n;
80105556:	e8 95 e2 ff ff       	call   801037f0 <myproc>
8010555b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010555e:	01 10                	add    %edx,(%eax)
  //if(growproc(n) < 0)
    //return -1;

	if((myproc()->sz + n) >= 0xfffffff) {
80105560:	e8 8b e2 ff ff       	call   801037f0 <myproc>
80105565:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105568:	03 10                	add    (%eax),%edx
8010556a:	81 fa fe ff ff 0f    	cmp    $0xffffffe,%edx
80105570:	0f 87 8a 00 00 00    	ja     80105600 <sys_sbrk+0xd0>
    cprintf("Allocating pages failed!\n");
       return -1;
  }
  myproc()->oldsz = myproc()->sz;
80105576:	e8 75 e2 ff ff       	call   801037f0 <myproc>
8010557b:	89 c6                	mov    %eax,%esi
8010557d:	e8 6e e2 ff ff       	call   801037f0 <myproc>
80105582:	8b 16                	mov    (%esi),%edx
80105584:	89 50 04             	mov    %edx,0x4(%eax)
  myproc()->sz = myproc()->sz + n;
80105587:	e8 64 e2 ff ff       	call   801037f0 <myproc>
8010558c:	8b 7d e4             	mov    -0x1c(%ebp),%edi
8010558f:	8b 30                	mov    (%eax),%esi
80105591:	e8 5a e2 ff ff       	call   801037f0 <myproc>
80105596:	01 fe                	add    %edi,%esi
80105598:	89 30                	mov    %esi,(%eax)
 	if(n < 0 && deallocuvm(myproc()->pgdir, myproc()->oldsz, myproc()->sz) == 0) {
8010559a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010559d:	85 c0                	test   %eax,%eax
8010559f:	78 0f                	js     801055b0 <sys_sbrk+0x80>
...
801055ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 	if(n < 0 && deallocuvm(myproc()->pgdir, myproc()->oldsz, myproc()->sz) == 0) {
801055b0:	e8 3b e2 ff ff       	call   801037f0 <myproc>
801055b5:	8b 38                	mov    (%eax),%edi
801055b7:	e8 34 e2 ff ff       	call   801037f0 <myproc>
801055bc:	8b 70 04             	mov    0x4(%eax),%esi
801055bf:	e8 2c e2 ff ff       	call   801037f0 <myproc>
801055c4:	83 ec 04             	sub    $0x4,%esp
801055c7:	57                   	push   %edi
801055c8:	56                   	push   %esi
801055c9:	ff 70 08             	pushl  0x8(%eax)
801055cc:	e8 0f 17 00 00       	call   80106ce0 <deallocuvm>
801055d1:	83 c4 10             	add    $0x10,%esp
801055d4:	85 c0                	test   %eax,%eax
801055d6:	75 c9                	jne    801055a1 <sys_sbrk+0x71>
    cprintf("Deallocating pages failed!\n");
801055d8:	83 ec 0c             	sub    $0xc,%esp
    return -1;
801055db:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    cprintf("Deallocating pages failed!\n");
801055e0:	68 f3 77 10 80       	push   $0x801077f3
801055e5:	e8 76 b0 ff ff       	call   80100660 <cprintf>
    return -1;
801055ea:	83 c4 10             	add    $0x10,%esp
801055ed:	eb b2                	jmp    801055a1 <sys_sbrk+0x71>
801055ef:	90                   	nop
    return -1;
801055f0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801055f5:	eb aa                	jmp    801055a1 <sys_sbrk+0x71>
801055f7:	89 f6                	mov    %esi,%esi
801055f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    cprintf("Allocating pages failed!\n");
80105600:	83 ec 0c             	sub    $0xc,%esp
       return -1;
80105603:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    cprintf("Allocating pages failed!\n");
80105608:	68 d9 77 10 80       	push   $0x801077d9
8010560d:	e8 4e b0 ff ff       	call   80100660 <cprintf>
       return -1;
80105612:	83 c4 10             	add    $0x10,%esp
80105615:	eb 8a                	jmp    801055a1 <sys_sbrk+0x71>
...
8010562d:	e8 4e f1 ff ff       	call   80104780 <argint>
...
80105686:	8b 40 28             	mov    0x28(%eax),%eax
...
80105737:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
8010573e:	08 00 00 8e 
80105742:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105749:	80 
8010574a:	c1 ea 10             	shr    $0x10,%edx
8010574d:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
80105754:	80 
  for(i = 0; i < 256; i++)
...
80105764:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105767:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
8010576e:	00 00 ef 
  initlock(&tickslock, "time");
80105771:	68 0f 78 10 80       	push   $0x8010780f
80105776:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010577b:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105781:	c1 e8 10             	shr    $0x10,%eax
80105784:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010578a:	e8 81 ea ff ff       	call   80104210 <initlock>
}
...
801057f0:	ff 24 85 e4 78 10 80 	jmp    *-0x7fef871c(,%eax,4)
...
80105800:	e8 eb df ff ff       	call   801037f0 <myproc>
80105805:	85 c0                	test   %eax,%eax
80105807:	0f 84 ce 02 00 00    	je     80105adb <trap+0x30b>
8010580d:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105811:	0f 84 c4 02 00 00    	je     80105adb <trap+0x30b>
...
8010581a:	e8 d1 df ff ff       	call   801037f0 <myproc>
8010581f:	39 18                	cmp    %ebx,(%eax)
80105821:	0f 82 19 02 00 00    	jb     80105a40 <trap+0x270>
...
8010582b:	0f 84 27 02 00 00    	je     80105a58 <trap+0x288>
...
80105867:	53                   	push   %ebx
            myproc()->pid, myproc()->name, tf->trapno,
80105868:	83 c2 70             	add    $0x70,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010586b:	52                   	push   %edx
8010586c:	ff 70 14             	pushl  0x14(%eax)
8010586f:	68 a0 78 10 80       	push   $0x801078a0
80105874:	e8 e7 ad ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105879:	83 c4 20             	add    $0x20,%esp
8010587c:	e8 6f df ff ff       	call   801037f0 <myproc>
80105881:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
}
...
80105888:	e8 63 df ff ff       	call   801037f0 <myproc>
8010588d:	85 c0                	test   %eax,%eax
8010588f:	74 1d                	je     801058ae <trap+0xde>
80105891:	e8 5a df ff ff       	call   801037f0 <myproc>
80105896:	8b 50 28             	mov    0x28(%eax),%edx
80105899:	85 d2                	test   %edx,%edx
8010589b:	74 11                	je     801058ae <trap+0xde>
8010589d:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801058a1:	83 e0 03             	and    $0x3,%eax
801058a4:	66 83 f8 03          	cmp    $0x3,%ax
801058a8:	0f 84 4a 01 00 00    	je     801059f8 <trap+0x228>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801058ae:	e8 3d df ff ff       	call   801037f0 <myproc>
801058b3:	85 c0                	test   %eax,%eax
801058b5:	74 0b                	je     801058c2 <trap+0xf2>
801058b7:	e8 34 df ff ff       	call   801037f0 <myproc>
801058bc:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
801058c0:	74 66                	je     80105928 <trap+0x158>
...
801058c9:	74 19                	je     801058e4 <trap+0x114>
801058cb:	e8 20 df ff ff       	call   801037f0 <myproc>
801058d0:	8b 40 28             	mov    0x28(%eax),%eax
801058d3:	85 c0                	test   %eax,%eax
801058d5:	74 0d                	je     801058e4 <trap+0x114>
801058d7:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801058db:	83 e0 03             	and    $0x3,%eax
801058de:	66 83 f8 03          	cmp    $0x3,%ax
801058e2:	74 35                	je     80105919 <trap+0x149>
    exit();
}
...
801058ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
801058f0:	e8 fb de ff ff       	call   801037f0 <myproc>
801058f5:	8b 58 28             	mov    0x28(%eax),%ebx
801058f8:	85 db                	test   %ebx,%ebx
801058fa:	0f 85 e8 00 00 00    	jne    801059e8 <trap+0x218>
    myproc()->tf = tf;
80105900:	e8 eb de ff ff       	call   801037f0 <myproc>
80105905:	89 78 1c             	mov    %edi,0x1c(%eax)
    syscall();
80105908:	e8 63 ef ff ff       	call   80104870 <syscall>
    if(myproc()->killed)
8010590d:	e8 de de ff ff       	call   801037f0 <myproc>
80105912:	8b 48 28             	mov    0x28(%eax),%ecx
80105915:	85 c9                	test   %ecx,%ecx
80105917:	74 cb                	je     801058e4 <trap+0x114>
}
...
8010591f:	5d                   	pop    %ebp
      exit();
80105920:	e9 eb e2 ff ff       	jmp    80103c10 <exit>
80105925:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105928:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
8010592c:	75 94                	jne    801058c2 <trap+0xf2>
    yield();
8010592e:	e8 0d e4 ff ff       	call   80103d40 <yield>
80105933:	eb 8d                	jmp    801058c2 <trap+0xf2>
80105935:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105938:	e8 93 de ff ff       	call   801037d0 <cpuid>
8010593d:	85 c0                	test   %eax,%eax
8010593f:	0f 84 c3 00 00 00    	je     80105a08 <trap+0x238>
    lapiceoi();
80105945:	e8 16 ce ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010594a:	e8 a1 de ff ff       	call   801037f0 <myproc>
8010594f:	85 c0                	test   %eax,%eax
80105951:	0f 85 3a ff ff ff    	jne    80105891 <trap+0xc1>
80105957:	e9 52 ff ff ff       	jmp    801058ae <trap+0xde>
8010595c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105960:	e8 bb cc ff ff       	call   80102620 <kbdintr>
    lapiceoi();
80105965:	e8 f6 cd ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010596a:	e8 81 de ff ff       	call   801037f0 <myproc>
8010596f:	85 c0                	test   %eax,%eax
80105971:	0f 85 1a ff ff ff    	jne    80105891 <trap+0xc1>
80105977:	e9 32 ff ff ff       	jmp    801058ae <trap+0xde>
8010597c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105980:	e8 fb 02 00 00       	call   80105c80 <uartintr>
    lapiceoi();
80105985:	e8 d6 cd ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010598a:	e8 61 de ff ff       	call   801037f0 <myproc>
8010598f:	85 c0                	test   %eax,%eax
80105991:	0f 85 fa fe ff ff    	jne    80105891 <trap+0xc1>
80105997:	e9 12 ff ff ff       	jmp    801058ae <trap+0xde>
...
801059af:	68 48 78 10 80       	push   $0x80107848
801059b4:	e8 a7 ac ff ff       	call   80100660 <cprintf>
    lapiceoi();
801059b9:	e8 a2 cd ff ff       	call   80102760 <lapiceoi>
    break;
801059be:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059c1:	e8 2a de ff ff       	call   801037f0 <myproc>
801059c6:	85 c0                	test   %eax,%eax
801059c8:	0f 85 c3 fe ff ff    	jne    80105891 <trap+0xc1>
801059ce:	e9 db fe ff ff       	jmp    801058ae <trap+0xde>
801059d3:	90                   	nop
801059d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
801059d8:	e8 b3 c6 ff ff       	call   80102090 <ideintr>
801059dd:	e9 63 ff ff ff       	jmp    80105945 <trap+0x175>
801059e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
801059e8:	e8 23 e2 ff ff       	call   80103c10 <exit>
801059ed:	e9 0e ff ff ff       	jmp    80105900 <trap+0x130>
801059f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
801059f8:	e8 13 e2 ff ff       	call   80103c10 <exit>
801059fd:	e9 ac fe ff ff       	jmp    801058ae <trap+0xde>
80105a02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105a08:	83 ec 0c             	sub    $0xc,%esp
80105a0b:	68 60 4d 11 80       	push   $0x80114d60
80105a10:	e8 3b e9 ff ff       	call   80104350 <acquire>
      wakeup(&ticks);
80105a15:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105a1c:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105a23:	e8 18 e5 ff ff       	call   80103f40 <wakeup>
      release(&tickslock);
80105a28:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105a2f:	e8 dc e9 ff ff       	call   80104410 <release>
80105a34:	83 c4 10             	add    $0x10,%esp
80105a37:	e9 09 ff ff ff       	jmp    80105945 <trap+0x175>
80105a3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        cprintf("unhandled page fault.\n");
80105a40:	83 ec 0c             	sub    $0xc,%esp
80105a43:	68 19 78 10 80       	push   $0x80107819
80105a48:	e8 13 ac ff ff       	call   80100660 <cprintf>
80105a4d:	83 c4 10             	add    $0x10,%esp
80105a50:	e9 dc fd ff ff       	jmp    80105831 <trap+0x61>
80105a55:	8d 76 00             	lea    0x0(%esi),%esi
        if(myproc()->sz < myproc()->oldsz) {  // not dealing with process size shrink 
80105a58:	e8 93 dd ff ff       	call   801037f0 <myproc>
80105a5d:	8b 18                	mov    (%eax),%ebx
80105a5f:	e8 8c dd ff ff       	call   801037f0 <myproc>
80105a64:	3b 58 04             	cmp    0x4(%eax),%ebx
80105a67:	0f 82 77 fe ff ff    	jb     801058e4 <trap+0x114>
80105a6d:	0f 20 d6             	mov    %cr2,%esi
        mem = kalloc();
80105a70:	e8 5b ca ff ff       	call   801024d0 <kalloc>
        if(mem == 0) {
80105a75:	85 c0                	test   %eax,%eax
        mem = kalloc();
80105a77:	89 c3                	mov    %eax,%ebx
        if(mem == 0) {
80105a79:	74 3f                	je     80105aba <trap+0x2ea>
        memset(mem, 0, PGSIZE);
80105a7b:	83 ec 04             	sub    $0x4,%esp
        mappages(myproc()->pgdir, (char*)addr, PGSIZE, V2P(mem), PTE_W|PTE_U);
80105a7e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
        addr = PGROUNDDOWN(rcr2());  // read cr2 register to find out what address the process is trying to access
80105a84:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
        memset(mem, 0, PGSIZE);
80105a8a:	68 00 10 00 00       	push   $0x1000
80105a8f:	6a 00                	push   $0x0
80105a91:	50                   	push   %eax
80105a92:	e8 c9 e9 ff ff       	call   80104460 <memset>
        mappages(myproc()->pgdir, (char*)addr, PGSIZE, V2P(mem), PTE_W|PTE_U);
80105a97:	e8 54 dd ff ff       	call   801037f0 <myproc>
80105a9c:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80105aa3:	53                   	push   %ebx
80105aa4:	68 00 10 00 00       	push   $0x1000
80105aa9:	56                   	push   %esi
80105aaa:	ff 70 08             	pushl  0x8(%eax)
80105aad:	e8 0e 0e 00 00       	call   801068c0 <mappages>
        break;
80105ab2:	83 c4 20             	add    $0x20,%esp
80105ab5:	e9 ce fd ff ff       	jmp    80105888 <trap+0xb8>
          cprintf("allocuvm out of memory\n");
80105aba:	83 ec 0c             	sub    $0xc,%esp
80105abd:	68 30 78 10 80       	push   $0x80107830
80105ac2:	e8 99 ab ff ff       	call   80100660 <cprintf>
          myproc()->killed = 1;
80105ac7:	e8 24 dd ff ff       	call   801037f0 <myproc>
          return;
80105acc:	83 c4 10             	add    $0x10,%esp
          myproc()->killed = 1;
80105acf:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
          return;
80105ad6:	e9 09 fe ff ff       	jmp    801058e4 <trap+0x114>
80105adb:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ade:	8b 5f 38             	mov    0x38(%edi),%ebx
80105ae1:	e8 ea dc ff ff       	call   801037d0 <cpuid>
80105ae6:	83 ec 0c             	sub    $0xc,%esp
80105ae9:	56                   	push   %esi
80105aea:	53                   	push   %ebx
80105aeb:	50                   	push   %eax
80105aec:	ff 77 30             	pushl  0x30(%edi)
80105aef:	68 6c 78 10 80       	push   $0x8010786c
80105af4:	e8 67 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105af9:	83 c4 14             	add    $0x14,%esp
80105afc:	68 14 78 10 80       	push   $0x80107814
...
80105b65:	e8 16 cc ff ff       	call   80102780 <microdelay>
...
80105bfc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105bff:	bb 64 79 10 80       	mov    $0x80107964,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c04:	6a 00                	push   $0x0
80105c06:	6a 04                	push   $0x4
80105c08:	e8 d3 c6 ff ff       	call   801022e0 <ioapicenable>
...
80105c97:	6a 00                	push   $0x0
  jmp alltraps
80105c99:	e9 5c fa ff ff       	jmp    801056fa <alltraps>
...
80105ca0:	6a 01                	push   $0x1
  jmp alltraps
80105ca2:	e9 53 fa ff ff       	jmp    801056fa <alltraps>
...
80105ca9:	6a 02                	push   $0x2
  jmp alltraps
80105cab:	e9 4a fa ff ff       	jmp    801056fa <alltraps>
...
80105cb2:	6a 03                	push   $0x3
  jmp alltraps
80105cb4:	e9 41 fa ff ff       	jmp    801056fa <alltraps>
...
80105cbb:	6a 04                	push   $0x4
  jmp alltraps
80105cbd:	e9 38 fa ff ff       	jmp    801056fa <alltraps>
...
80105cc4:	6a 05                	push   $0x5
  jmp alltraps
80105cc6:	e9 2f fa ff ff       	jmp    801056fa <alltraps>
...
80105ccd:	6a 06                	push   $0x6
  jmp alltraps
80105ccf:	e9 26 fa ff ff       	jmp    801056fa <alltraps>
...
80105cd6:	6a 07                	push   $0x7
  jmp alltraps
80105cd8:	e9 1d fa ff ff       	jmp    801056fa <alltraps>
...
80105cdd:	6a 08                	push   $0x8
  jmp alltraps
80105cdf:	e9 16 fa ff ff       	jmp    801056fa <alltraps>
...
80105ce6:	6a 09                	push   $0x9
  jmp alltraps
80105ce8:	e9 0d fa ff ff       	jmp    801056fa <alltraps>
...
80105ced:	6a 0a                	push   $0xa
  jmp alltraps
80105cef:	e9 06 fa ff ff       	jmp    801056fa <alltraps>
...
80105cf4:	6a 0b                	push   $0xb
  jmp alltraps
80105cf6:	e9 ff f9 ff ff       	jmp    801056fa <alltraps>
...
80105d02:	6a 0d                	push   $0xd
  jmp alltraps
80105d04:	e9 f1 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d09:	6a 0e                	push   $0xe
  jmp alltraps
80105d0b:	e9 ea f9 ff ff       	jmp    801056fa <alltraps>
...
80105d12:	6a 0f                	push   $0xf
  jmp alltraps
80105d14:	e9 e1 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d1b:	6a 10                	push   $0x10
  jmp alltraps
80105d1d:	e9 d8 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d22:	6a 11                	push   $0x11
  jmp alltraps
80105d24:	e9 d1 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d2b:	6a 12                	push   $0x12
  jmp alltraps
80105d2d:	e9 c8 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d34:	6a 13                	push   $0x13
  jmp alltraps
80105d36:	e9 bf f9 ff ff       	jmp    801056fa <alltraps>
...
80105d3d:	6a 14                	push   $0x14
  jmp alltraps
80105d3f:	e9 b6 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d46:	6a 15                	push   $0x15
  jmp alltraps
80105d48:	e9 ad f9 ff ff       	jmp    801056fa <alltraps>
...
80105d4f:	6a 16                	push   $0x16
  jmp alltraps
80105d51:	e9 a4 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d58:	6a 17                	push   $0x17
  jmp alltraps
80105d5a:	e9 9b f9 ff ff       	jmp    801056fa <alltraps>
...
80105d61:	6a 18                	push   $0x18
  jmp alltraps
80105d63:	e9 92 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d6a:	6a 19                	push   $0x19
  jmp alltraps
80105d6c:	e9 89 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d73:	6a 1a                	push   $0x1a
  jmp alltraps
80105d75:	e9 80 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d7c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d7e:	e9 77 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d85:	6a 1c                	push   $0x1c
  jmp alltraps
80105d87:	e9 6e f9 ff ff       	jmp    801056fa <alltraps>
...
80105d8e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d90:	e9 65 f9 ff ff       	jmp    801056fa <alltraps>
...
80105d97:	6a 1e                	push   $0x1e
  jmp alltraps
80105d99:	e9 5c f9 ff ff       	jmp    801056fa <alltraps>
...
80105da0:	6a 1f                	push   $0x1f
  jmp alltraps
80105da2:	e9 53 f9 ff ff       	jmp    801056fa <alltraps>
...
80105da9:	6a 20                	push   $0x20
  jmp alltraps
80105dab:	e9 4a f9 ff ff       	jmp    801056fa <alltraps>
...
80105db2:	6a 21                	push   $0x21
  jmp alltraps
80105db4:	e9 41 f9 ff ff       	jmp    801056fa <alltraps>
...
80105dbb:	6a 22                	push   $0x22
  jmp alltraps
80105dbd:	e9 38 f9 ff ff       	jmp    801056fa <alltraps>
...
80105dc4:	6a 23                	push   $0x23
  jmp alltraps
80105dc6:	e9 2f f9 ff ff       	jmp    801056fa <alltraps>
...
80105dcd:	6a 24                	push   $0x24
  jmp alltraps
80105dcf:	e9 26 f9 ff ff       	jmp    801056fa <alltraps>
...
80105dd6:	6a 25                	push   $0x25
  jmp alltraps
80105dd8:	e9 1d f9 ff ff       	jmp    801056fa <alltraps>
...
80105ddf:	6a 26                	push   $0x26
  jmp alltraps
80105de1:	e9 14 f9 ff ff       	jmp    801056fa <alltraps>
...
80105de8:	6a 27                	push   $0x27
  jmp alltraps
80105dea:	e9 0b f9 ff ff       	jmp    801056fa <alltraps>
...
80105df1:	6a 28                	push   $0x28
  jmp alltraps
80105df3:	e9 02 f9 ff ff       	jmp    801056fa <alltraps>
...
80105dfa:	6a 29                	push   $0x29
  jmp alltraps
80105dfc:	e9 f9 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e03:	6a 2a                	push   $0x2a
  jmp alltraps
80105e05:	e9 f0 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e0c:	6a 2b                	push   $0x2b
  jmp alltraps
80105e0e:	e9 e7 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e15:	6a 2c                	push   $0x2c
  jmp alltraps
80105e17:	e9 de f8 ff ff       	jmp    801056fa <alltraps>
...
80105e1e:	6a 2d                	push   $0x2d
  jmp alltraps
80105e20:	e9 d5 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e27:	6a 2e                	push   $0x2e
  jmp alltraps
80105e29:	e9 cc f8 ff ff       	jmp    801056fa <alltraps>
...
80105e30:	6a 2f                	push   $0x2f
  jmp alltraps
80105e32:	e9 c3 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e39:	6a 30                	push   $0x30
  jmp alltraps
80105e3b:	e9 ba f8 ff ff       	jmp    801056fa <alltraps>
...
80105e42:	6a 31                	push   $0x31
  jmp alltraps
80105e44:	e9 b1 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e4b:	6a 32                	push   $0x32
  jmp alltraps
80105e4d:	e9 a8 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e54:	6a 33                	push   $0x33
  jmp alltraps
80105e56:	e9 9f f8 ff ff       	jmp    801056fa <alltraps>
...
80105e5d:	6a 34                	push   $0x34
  jmp alltraps
80105e5f:	e9 96 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e66:	6a 35                	push   $0x35
  jmp alltraps
80105e68:	e9 8d f8 ff ff       	jmp    801056fa <alltraps>
...
80105e6f:	6a 36                	push   $0x36
  jmp alltraps
80105e71:	e9 84 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e78:	6a 37                	push   $0x37
  jmp alltraps
80105e7a:	e9 7b f8 ff ff       	jmp    801056fa <alltraps>
...
80105e81:	6a 38                	push   $0x38
  jmp alltraps
80105e83:	e9 72 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e8a:	6a 39                	push   $0x39
  jmp alltraps
80105e8c:	e9 69 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e93:	6a 3a                	push   $0x3a
  jmp alltraps
80105e95:	e9 60 f8 ff ff       	jmp    801056fa <alltraps>
...
80105e9c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e9e:	e9 57 f8 ff ff       	jmp    801056fa <alltraps>
...
80105ea5:	6a 3c                	push   $0x3c
  jmp alltraps
80105ea7:	e9 4e f8 ff ff       	jmp    801056fa <alltraps>
...
80105eae:	6a 3d                	push   $0x3d
  jmp alltraps
80105eb0:	e9 45 f8 ff ff       	jmp    801056fa <alltraps>
...
80105eb7:	6a 3e                	push   $0x3e
  jmp alltraps
80105eb9:	e9 3c f8 ff ff       	jmp    801056fa <alltraps>
...
80105ec0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ec2:	e9 33 f8 ff ff       	jmp    801056fa <alltraps>
...
80105ec9:	6a 40                	push   $0x40
  jmp alltraps
80105ecb:	e9 2a f8 ff ff       	jmp    801056fa <alltraps>
...
80105ed2:	6a 41                	push   $0x41
  jmp alltraps
80105ed4:	e9 21 f8 ff ff       	jmp    801056fa <alltraps>
...
80105edb:	6a 42                	push   $0x42
  jmp alltraps
80105edd:	e9 18 f8 ff ff       	jmp    801056fa <alltraps>
...
80105ee4:	6a 43                	push   $0x43
  jmp alltraps
80105ee6:	e9 0f f8 ff ff       	jmp    801056fa <alltraps>
...
80105eed:	6a 44                	push   $0x44
  jmp alltraps
80105eef:	e9 06 f8 ff ff       	jmp    801056fa <alltraps>
...
80105ef6:	6a 45                	push   $0x45
  jmp alltraps
80105ef8:	e9 fd f7 ff ff       	jmp    801056fa <alltraps>
...
80105eff:	6a 46                	push   $0x46
  jmp alltraps
80105f01:	e9 f4 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f08:	6a 47                	push   $0x47
  jmp alltraps
80105f0a:	e9 eb f7 ff ff       	jmp    801056fa <alltraps>
...
80105f11:	6a 48                	push   $0x48
  jmp alltraps
80105f13:	e9 e2 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f1a:	6a 49                	push   $0x49
  jmp alltraps
80105f1c:	e9 d9 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f23:	6a 4a                	push   $0x4a
  jmp alltraps
80105f25:	e9 d0 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f2c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f2e:	e9 c7 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f35:	6a 4c                	push   $0x4c
  jmp alltraps
80105f37:	e9 be f7 ff ff       	jmp    801056fa <alltraps>
...
80105f3e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f40:	e9 b5 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f47:	6a 4e                	push   $0x4e
  jmp alltraps
80105f49:	e9 ac f7 ff ff       	jmp    801056fa <alltraps>
...
80105f50:	6a 4f                	push   $0x4f
  jmp alltraps
80105f52:	e9 a3 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f59:	6a 50                	push   $0x50
  jmp alltraps
80105f5b:	e9 9a f7 ff ff       	jmp    801056fa <alltraps>
...
80105f62:	6a 51                	push   $0x51
  jmp alltraps
80105f64:	e9 91 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f6b:	6a 52                	push   $0x52
  jmp alltraps
80105f6d:	e9 88 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f74:	6a 53                	push   $0x53
  jmp alltraps
80105f76:	e9 7f f7 ff ff       	jmp    801056fa <alltraps>
...
80105f7d:	6a 54                	push   $0x54
  jmp alltraps
80105f7f:	e9 76 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f86:	6a 55                	push   $0x55
  jmp alltraps
80105f88:	e9 6d f7 ff ff       	jmp    801056fa <alltraps>
...
80105f8f:	6a 56                	push   $0x56
  jmp alltraps
80105f91:	e9 64 f7 ff ff       	jmp    801056fa <alltraps>
...
80105f98:	6a 57                	push   $0x57
  jmp alltraps
80105f9a:	e9 5b f7 ff ff       	jmp    801056fa <alltraps>
...
80105fa1:	6a 58                	push   $0x58
  jmp alltraps
80105fa3:	e9 52 f7 ff ff       	jmp    801056fa <alltraps>
...
80105faa:	6a 59                	push   $0x59
  jmp alltraps
80105fac:	e9 49 f7 ff ff       	jmp    801056fa <alltraps>
...
80105fb3:	6a 5a                	push   $0x5a
  jmp alltraps
80105fb5:	e9 40 f7 ff ff       	jmp    801056fa <alltraps>
...
80105fbc:	6a 5b                	push   $0x5b
  jmp alltraps
80105fbe:	e9 37 f7 ff ff       	jmp    801056fa <alltraps>
...
80105fc5:	6a 5c                	push   $0x5c
  jmp alltraps
80105fc7:	e9 2e f7 ff ff       	jmp    801056fa <alltraps>
...
80105fce:	6a 5d                	push   $0x5d
  jmp alltraps
80105fd0:	e9 25 f7 ff ff       	jmp    801056fa <alltraps>
...
80105fd7:	6a 5e                	push   $0x5e
  jmp alltraps
80105fd9:	e9 1c f7 ff ff       	jmp    801056fa <alltraps>
...
80105fe0:	6a 5f                	push   $0x5f
  jmp alltraps
80105fe2:	e9 13 f7 ff ff       	jmp    801056fa <alltraps>
...
80105fe9:	6a 60                	push   $0x60
  jmp alltraps
80105feb:	e9 0a f7 ff ff       	jmp    801056fa <alltraps>
...
80105ff2:	6a 61                	push   $0x61
  jmp alltraps
80105ff4:	e9 01 f7 ff ff       	jmp    801056fa <alltraps>
...
80105ffb:	6a 62                	push   $0x62
  jmp alltraps
80105ffd:	e9 f8 f6 ff ff       	jmp    801056fa <alltraps>
...
80106004:	6a 63                	push   $0x63
  jmp alltraps
80106006:	e9 ef f6 ff ff       	jmp    801056fa <alltraps>
...
8010600d:	6a 64                	push   $0x64
  jmp alltraps
8010600f:	e9 e6 f6 ff ff       	jmp    801056fa <alltraps>
...
80106016:	6a 65                	push   $0x65
  jmp alltraps
80106018:	e9 dd f6 ff ff       	jmp    801056fa <alltraps>
...
8010601f:	6a 66                	push   $0x66
  jmp alltraps
80106021:	e9 d4 f6 ff ff       	jmp    801056fa <alltraps>
...
80106028:	6a 67                	push   $0x67
  jmp alltraps
8010602a:	e9 cb f6 ff ff       	jmp    801056fa <alltraps>
...
80106031:	6a 68                	push   $0x68
  jmp alltraps
80106033:	e9 c2 f6 ff ff       	jmp    801056fa <alltraps>
...
8010603a:	6a 69                	push   $0x69
  jmp alltraps
8010603c:	e9 b9 f6 ff ff       	jmp    801056fa <alltraps>
...
80106043:	6a 6a                	push   $0x6a
  jmp alltraps
80106045:	e9 b0 f6 ff ff       	jmp    801056fa <alltraps>
...
80106055:	6a 6c                	push   $0x6c
  jmp alltraps
80106057:	e9 9e f6 ff ff       	jmp    801056fa <alltraps>
...
8010605e:	6a 6d                	push   $0x6d
  jmp alltraps
80106060:	e9 95 f6 ff ff       	jmp    801056fa <alltraps>
...
80106067:	6a 6e                	push   $0x6e
  jmp alltraps
80106069:	e9 8c f6 ff ff       	jmp    801056fa <alltraps>
...
80106079:	6a 70                	push   $0x70
  jmp alltraps
8010607b:	e9 7a f6 ff ff       	jmp    801056fa <alltraps>
...
80106082:	6a 71                	push   $0x71
  jmp alltraps
80106084:	e9 71 f6 ff ff       	jmp    801056fa <alltraps>
...
8010608b:	6a 72                	push   $0x72
  jmp alltraps
8010608d:	e9 68 f6 ff ff       	jmp    801056fa <alltraps>
...
8010609d:	6a 74                	push   $0x74
  jmp alltraps
8010609f:	e9 56 f6 ff ff       	jmp    801056fa <alltraps>
...
801060a6:	6a 75                	push   $0x75
  jmp alltraps
801060a8:	e9 4d f6 ff ff       	jmp    801056fa <alltraps>
...
801060af:	6a 76                	push   $0x76
  jmp alltraps
801060b1:	e9 44 f6 ff ff       	jmp    801056fa <alltraps>
...
801060c1:	6a 78                	push   $0x78
  jmp alltraps
801060c3:	e9 32 f6 ff ff       	jmp    801056fa <alltraps>
...
801060ca:	6a 79                	push   $0x79
  jmp alltraps
801060cc:	e9 29 f6 ff ff       	jmp    801056fa <alltraps>
...
801060d3:	6a 7a                	push   $0x7a
  jmp alltraps
801060d5:	e9 20 f6 ff ff       	jmp    801056fa <alltraps>
...
801060e5:	6a 7c                	push   $0x7c
  jmp alltraps
801060e7:	e9 0e f6 ff ff       	jmp    801056fa <alltraps>
...
801060ee:	6a 7d                	push   $0x7d
  jmp alltraps
801060f0:	e9 05 f6 ff ff       	jmp    801056fa <alltraps>
...
801060f7:	6a 7e                	push   $0x7e
  jmp alltraps
801060f9:	e9 fc f5 ff ff       	jmp    801056fa <alltraps>
...
80106649:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010664e:	e9 a7 f0 ff ff       	jmp    801056fa <alltraps>
...
80106655:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010665a:	e9 9b f0 ff ff       	jmp    801056fa <alltraps>
...
80106661:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106666:	e9 8f f0 ff ff       	jmp    801056fa <alltraps>
...
8010666d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106672:	e9 83 f0 ff ff       	jmp    801056fa <alltraps>
...
80106679:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010667e:	e9 77 f0 ff ff       	jmp    801056fa <alltraps>
...
80106685:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010668a:	e9 6b f0 ff ff       	jmp    801056fa <alltraps>
...
80106691:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106696:	e9 5f f0 ff ff       	jmp    801056fa <alltraps>
...
8010669d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066a2:	e9 53 f0 ff ff       	jmp    801056fa <alltraps>
...
801066a9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066ae:	e9 47 f0 ff ff       	jmp    801056fa <alltraps>
...
801066b5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066ba:	e9 3b f0 ff ff       	jmp    801056fa <alltraps>
...
801066c1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066c6:	e9 2f f0 ff ff       	jmp    801056fa <alltraps>
...
801066cd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801066d2:	e9 23 f0 ff ff       	jmp    801056fa <alltraps>
...
801066d9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066de:	e9 17 f0 ff ff       	jmp    801056fa <alltraps>
...
801066e5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066ea:	e9 0b f0 ff ff       	jmp    801056fa <alltraps>
...
801066f1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801066f6:	e9 ff ef ff ff       	jmp    801056fa <alltraps>
...
801066fd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106702:	e9 f3 ef ff ff       	jmp    801056fa <alltraps>
...
80106754:	e8 77 bd ff ff       	call   801024d0 <kalloc>
...
8010676a:	e8 f1 dc ff ff       	call   80104460 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801067f5:	e8 16 ff ff ff       	call   80106710 <walkpgdir>
    if(!pte)
...
80106822:	68 a6 72 10 80       	push   $0x801072a6
...
801068c9:	8b 45 0c             	mov    0xc(%ebp),%eax
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801068cc:	8b 55 10             	mov    0x10(%ebp),%edx
801068cf:	8b 7d 14             	mov    0x14(%ebp),%edi
  a = (char*)PGROUNDDOWN((uint)va);
801068d2:	89 c3                	mov    %eax,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801068d4:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
  a = (char*)PGROUNDDOWN((uint)va);
801068d8:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801068de:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801068e3:	29 df                	sub    %ebx,%edi
801068e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    *pte = pa | perm | PTE_P;
801068e8:	8b 45 18             	mov    0x18(%ebp),%eax
801068eb:	83 c8 01             	or     $0x1,%eax
801068ee:	89 45 e0             	mov    %eax,-0x20(%ebp)
801068f1:	eb 1a                	jmp    8010690d <mappages+0x4d>
801068f3:	90                   	nop
801068f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(*pte & PTE_P)
801068f8:	f6 00 01             	testb  $0x1,(%eax)
801068fb:	75 3d                	jne    8010693a <mappages+0x7a>
    *pte = pa | perm | PTE_P;
801068fd:	0b 75 e0             	or     -0x20(%ebp),%esi
    if(a == last)
80106900:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
    *pte = pa | perm | PTE_P;
80106903:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106905:	74 29                	je     80106930 <mappages+0x70>
    a += PGSIZE;
80106907:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010690d:	8b 45 08             	mov    0x8(%ebp),%eax
80106910:	b9 01 00 00 00       	mov    $0x1,%ecx
80106915:	89 da                	mov    %ebx,%edx
80106917:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
8010691a:	e8 f1 fd ff ff       	call   80106710 <walkpgdir>
8010691f:	85 c0                	test   %eax,%eax
80106921:	75 d5                	jne    801068f8 <mappages+0x38>
}
...
8010693d:	68 6c 79 10 80       	push   $0x8010796c
...
80106a16:	8b 73 0c             	mov    0xc(%ebx),%esi
...
80106a38:	8b 43 08             	mov    0x8(%ebx),%eax
...
80106a98:	77 50                	ja     80106aea <inituvm+0x6a>
80106a9a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
80106a9d:	e8 2e ba ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106aaf:	e8 ac d9 ff ff       	call   80104460 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106ab4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106ab7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106abd:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106ac4:	50                   	push   %eax
80106ac5:	68 00 10 00 00       	push   $0x1000
80106aca:	6a 00                	push   $0x0
80106acc:	52                   	push   %edx
80106acd:	e8 ee fd ff ff       	call   801068c0 <mappages>
  memmove(mem, init, sz);
80106ad2:	89 75 10             	mov    %esi,0x10(%ebp)
80106ad5:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106ad8:	83 c4 20             	add    $0x20,%esp
80106adb:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106ae4:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ae5:	e9 26 da ff ff       	jmp    80104510 <memmove>
    panic("inituvm: more than a page");
80106aea:	83 ec 0c             	sub    $0xc,%esp
80106aed:	68 b1 79 10 80       	push   $0x801079b1
...
80106b71:	e8 fa ad ff ff       	call   80101970 <readi>
...
80106bce:	0f 88 8f 00 00 00    	js     80106c63 <allocuvm+0xa3>
  if(newsz < oldsz)
...
80106bfb:	eb 43                	jmp    80106c40 <allocuvm+0x80>
...
80106c0b:	e8 50 d8 ff ff       	call   80104460 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106c10:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106c16:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106c1d:	50                   	push   %eax
80106c1e:	68 00 10 00 00       	push   $0x1000
80106c23:	53                   	push   %ebx
80106c24:	56                   	push   %esi
80106c25:	e8 96 fc ff ff       	call   801068c0 <mappages>
80106c2a:	83 c4 20             	add    $0x20,%esp
80106c2d:	85 c0                	test   %eax,%eax
80106c2f:	78 4f                	js     80106c80 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80106c31:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c37:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80106c3a:	0f 86 80 00 00 00    	jbe    80106cc0 <allocuvm+0x100>
    mem = kalloc();
80106c40:	e8 8b b8 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
80106c45:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106c47:	89 c7                	mov    %eax,%edi
    if(mem == 0){
80106c49:	75 b5                	jne    80106c00 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106c4b:	83 ec 0c             	sub    $0xc,%esp
80106c4e:	68 30 78 10 80       	push   $0x80107830
80106c53:	e8 08 9a ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106c58:	83 c4 10             	add    $0x10,%esp
80106c5b:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c5e:	39 45 10             	cmp    %eax,0x10(%ebp)
80106c61:	77 6d                	ja     80106cd0 <allocuvm+0x110>
}
80106c63:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106c66:	31 ff                	xor    %edi,%edi
}
80106c68:	89 f8                	mov    %edi,%eax
80106c6a:	5b                   	pop    %ebx
80106c6b:	5e                   	pop    %esi
80106c6c:	5f                   	pop    %edi
80106c6d:	5d                   	pop    %ebp
...
80106c83:	89 fe                	mov    %edi,%esi
80106c85:	68 e9 79 10 80       	push   $0x801079e9
80106c8a:	e8 d1 99 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106c8f:	83 c4 10             	add    $0x10,%esp
80106c92:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c95:	39 45 10             	cmp    %eax,0x10(%ebp)
80106c98:	76 0d                	jbe    80106ca7 <allocuvm+0xe7>
80106c9a:	89 c1                	mov    %eax,%ecx
80106c9c:	8b 55 10             	mov    0x10(%ebp),%edx
80106c9f:	8b 45 08             	mov    0x8(%ebp),%eax
80106ca2:	e8 e9 fa ff ff       	call   80106790 <deallocuvm.part.0>
      kfree(mem);
80106ca7:	83 ec 0c             	sub    $0xc,%esp
      return 0;
80106caa:	31 ff                	xor    %edi,%edi
      kfree(mem);
80106cac:	56                   	push   %esi
80106cad:	e8 6e b6 ff ff       	call   80102320 <kfree>
      return 0;
...
80106cd8:	e8 b3 fa ff ff       	call   80106790 <deallocuvm.part.0>
80106cdd:	eb 94                	jmp    80106c73 <allocuvm+0xb3>
80106cdf:	90                   	nop
...
80106cf0:	5d                   	pop    %ebp
80106cf1:	e9 9a fa ff ff       	jmp    80106790 <deallocuvm.part.0>
...
80106d29:	e8 62 fa ff ff       	call   80106790 <deallocuvm.part.0>
...
80106d7c:	68 05 7a 10 80       	push   $0x80107a05
...
80106e3e:	e8 cd f8 ff ff       	call   80106710 <walkpgdir>
  if(pte == 0)
...
80106e4f:	68 16 7a 10 80       	push   $0x80107a16
...
80106e73:	0f 84 a2 00 00 00    	je     80106f1b <copyuvm+0xbb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106e79:	8b 55 0c             	mov    0xc(%ebp),%edx
80106e7c:	85 d2                	test   %edx,%edx
80106e7e:	0f 84 97 00 00 00    	je     80106f1b <copyuvm+0xbb>
80106e84:	31 f6                	xor    %esi,%esi
80106e86:	eb 48                	jmp    80106ed0 <copyuvm+0x70>
80106e88:	90                   	nop
...
80106ea0:	e8 6b d6 ff ff       	call   80104510 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106ea5:	58                   	pop    %eax
80106ea6:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106eac:	ff 75 e4             	pushl  -0x1c(%ebp)
80106eaf:	50                   	push   %eax
80106eb0:	68 00 10 00 00       	push   $0x1000
80106eb5:	56                   	push   %esi
80106eb6:	ff 75 e0             	pushl  -0x20(%ebp)
80106eb9:	e8 02 fa ff ff       	call   801068c0 <mappages>
80106ebe:	83 c4 20             	add    $0x20,%esp
80106ec1:	85 c0                	test   %eax,%eax
80106ec3:	78 6b                	js     80106f30 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
80106ec5:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106ecb:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106ece:	76 4b                	jbe    80106f1b <copyuvm+0xbb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106ed0:	8b 45 08             	mov    0x8(%ebp),%eax
80106ed3:	31 c9                	xor    %ecx,%ecx
80106ed5:	89 f2                	mov    %esi,%edx
80106ed7:	e8 34 f8 ff ff       	call   80106710 <walkpgdir>
80106edc:	85 c0                	test   %eax,%eax
80106ede:	74 6b                	je     80106f4b <copyuvm+0xeb>
    if(!(*pte & PTE_P))
80106ee0:	8b 38                	mov    (%eax),%edi
80106ee2:	f7 c7 01 00 00 00    	test   $0x1,%edi
80106ee8:	74 54                	je     80106f3e <copyuvm+0xde>
    pa = PTE_ADDR(*pte);
80106eea:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
80106eec:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80106ef2:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106ef5:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if((mem = kalloc()) == 0)
80106efb:	e8 d0 b5 ff ff       	call   801024d0 <kalloc>
80106f00:	85 c0                	test   %eax,%eax
80106f02:	89 c7                	mov    %eax,%edi
80106f04:	75 8a                	jne    80106e90 <copyuvm+0x30>
    }
  }
  return d;
...
80106f09:	ff 75 e0             	pushl  -0x20(%ebp)
80106f0c:	e8 ff fd ff ff       	call   80106d10 <freevm>
  return 0;
80106f11:	83 c4 10             	add    $0x10,%esp
80106f14:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
80106f1b:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106f34:	e8 e7 b3 ff ff       	call   80102320 <kfree>
      goto bad;
80106f39:	83 c4 10             	add    $0x10,%esp
80106f3c:	eb c8                	jmp    80106f06 <copyuvm+0xa6>
      panic("copyuvm: page not present");
80106f3e:	83 ec 0c             	sub    $0xc,%esp
80106f41:	68 3a 7a 10 80       	push   $0x80107a3a
80106f46:	e8 45 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106f4b:	83 ec 0c             	sub    $0xc,%esp
80106f4e:	68 20 7a 10 80       	push   $0x80107a20
80106f53:	e8 38 94 ff ff       	call   80100390 <panic>
80106f58:	90                   	nop
...
80106fdf:	e8 2c d5 ff ff       	call   80104510 <memmove>
    len -= n;
    buf += n;
